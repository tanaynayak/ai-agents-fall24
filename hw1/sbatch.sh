...
#SBATCH --time=8:00:00                 # Memory per CPU
#SBATCH --job-name="ai-agents-hw"    # Set the job name
...
source ~/.bashrc
conda activate ai-agents # activate the Python environment

# runs your code
python3 hw1_outputs.py